...
import 'item_widgetK.dart';

class ProductsK extends StatefulWidget {
  const ProductsK(
  ...
  @override
  State<ProductsK> createState() => _ProductsKState();
}

class _ProductsKState extends State<ProductsK> {
  late List data = [];
